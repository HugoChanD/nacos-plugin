...
public class ConfigTagsRelationMapperByOscar extends OscarAbstractMapper implements ConfigTagsRelationMapper {
    ...
    public MapperResult findConfigInfo4PageFetchRows(MapperContext context) {
        ...
        String resultSql = sql + where + " AND  ROWNUM > " + sql + " AND ROWNUM <= " + (startRow + pageSize);
